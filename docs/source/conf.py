...
# -- Project information
project = 'rest-certain/hamcrest-phpunit'
...
html_title = 'REST Certain Hamcrest Matchers for PHPUnit, %s' % version
html_short_title = 'Hamcrest for PHPUnit'
html_context = {
    'display_github': True,
    'github_user': 'rest-certain',
    'github_repo': 'hamcrest-phpunit',
