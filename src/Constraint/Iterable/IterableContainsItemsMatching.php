...
/**
 * The examined iterable must contain items that match each of the constraints. The items may be in any order, and the
 * number of items matched by the constraints does not matter, as long as all the constraints are satisfied.
 */
final class IterableContainsItemsMatching extends Constraint
{
    /**
     * @var Constraint[]
     */
    ...
    {
        return implode(' or ', array_map(fn (Constraint $c) => $c->toString(), $this->constraints));
    }
    ...
    protected function failureDescription(mixed $other): string
    {
        ...
        return sprintf('value is an iterable that contains an item that %s', $this->toString());
    }
    ...
    protected function matches(mixed $other): bool
    {
        ...
        return $successes === count($this->constraints);
    }
}
