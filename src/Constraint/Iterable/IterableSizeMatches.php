...
final class IterableSizeMatches extends Count
{
    ...
    protected function failureDescription(mixed $other): string
    {
        ...
        if ($this->constraint instanceof Count) {
            return sprintf('value is an iterable with a %s', $this->toString());
        }

        if ($this->constraint instanceof IsEmpty) {
            return 'value is an empty iterable';
        }

        return sprintf('value is an iterable with a size that %s', $this->toString());
    }
