...
/**
 * The items in the examined iterable must satisfy each corresponding constraint provided, in the same relative order.
 */
final class IterableMatchesItemsInRelativeOrder extends Constraint
{
    /**
     * @var Constraint[]
     */
    ...
    protected function failureDescription(mixed $other): string
    {
        ...
        return sprintf('value is an iterable where each item (in relative order) %s', $this->toString());
    }
    ...
    protected function matches(mixed $other): bool
    {
        ...
        $constraintStack = $this->constraints;
        $constraint = array_shift($constraintStack);
        ...
        return $matches === count($this->constraints);
    }
}
