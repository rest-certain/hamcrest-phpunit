...
class GreaterThanOrEqualTo extends Constraint
{
    ...
    {
        $this->greaterThan = new GreaterThan($value);
        $this->isEqual = new IsEqual($value);
    }

    #[Override] public function toString(): string
    {
        return 'is greater than or equal to ' . Exporter::export($this->value);
    }

    #[Override] protected function matches(mixed $other): bool
    {
        return $this->greaterThan->evaluate($other, '', true) || $this->isEqual->evaluate($other, '', true);
    }
}
