...
final class StringStartsWithIgnoringCase extends Constraint
{
    /**
    ...
    {
        return sprintf('starts with %s, ignoring case', Exporter::export($this->prefix));
    }
    ...
    protected function matches(mixed $other): bool
    {
        ...
        return str_starts_with(strtolower((string) $other), strtolower($this->prefix));
    }
}
