...
* GitHub Issues: <https://github.com/rest-certain/hamcrest-phpunit/issues>
...
* rest-certain/hamcrest-phpunit follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  rest-certain/hamcrest-phpunit automatically runs tests for pull requests. However,
...
[github]: https://github.com/rest-certain/hamcrest-phpunit
[issues]: https://github.com/rest-certain/hamcrest-phpunit/issues
[pull requests]: https://github.com/rest-certain/hamcrest-phpunit/pulls
